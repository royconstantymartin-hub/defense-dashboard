...
export function OfficialLinksPanel({ links }: { links: Array<{ label: string; url?: string }> }) {
  return (
    <div className="rounded-xl border border-border bg-panel p-4">
      <h3 className="mb-2 text-xs uppercase tracking-[0.12em] text-textMuted">Official Links</h3>
