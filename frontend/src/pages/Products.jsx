...
const STATIC_PRODUCT_IMAGES = {
  ...
  "Harfang MALE":             WKC + "Harfang_uav.jpg",
  "Patroller MALE":           WKC + "Safran_Patroller_MALE_UAS.jpg",
  ...
  "EC725 Caracal":            WKC + "H225M_Caracal_Malaysian_Air_Force.jpg",
  "AS 532 Cougar":            WKC + "AS_532_Cougar_FLIR.jpg",
  "SA 342 Gazelle":           WKC + "Eurocopter_Gazelle_of_the_French_Army.jpg",
  "AS 565 Panther":           WKC + "AS565_Panther_Samp_T.jpg",
  ...
  // ── UAVs (recent additions) ──────────────────────────────────────────────
  "Bayraktar Akinci":            WKC + "Bayraktar_Ak%C4%B1nc%C4%B1_UCAV.jpg",
  "TAI ANKA-S":                  WKC + "TAI_Anka_UAV.jpg",
  "TAI Aksungur":                WKC + "TAI_Aksungur.jpg",
  "Elbit Hermes 450":            WKC + "Hermes_450.jpg",
  "Elbit Hermes 900":            WKC + "Hermes_900_at_the_Paris_Air_Show_2019.jpg",
  "IAI Heron 1 (Machatz-1)":    WKC + "IAI_Heron_1.jpg",
  "IAI Eitan (Heron 10)":        WKC + "IAI_Eitan.jpg",
  "Heron TP":                    WKC + "IAI_Eitan.jpg",
  "CH-4B Rainbow (Caihong-4B)": WKC + "CH-4_UAV.jpg",
  "Wing Loong II":               WKC + "Wing_Loong_II.jpg",
  "MQ-25 Stingray":              WKC + "MQ-25_Stingray.jpg",
  "RQ-170 Sentinel":             WKC + "RQ-170_Sentinel_at_Kandahar_Airfield.jpg",
  "Northrop Grumman MQ-8C Fire Scout": WKC + "MQ-8C_Fire_Scout.jpg",
  "Sukhoi S-70 Okhotnik-B":     WKC + "S-70_Okhotnik-B_UAV.jpg",
  "Shahed-136":                  WKC + "Shahed-136.jpg",
  "Shahed-131":                  WKC + "Shahed-131.jpg",
  "Shahed-129":                  WKC + "Shahed_129.jpg",
  "Mohajer-6":                   WKC + "Mohajer-6_drone.jpg",
  "Airbus Zephyr S":             WKC + "Airbus_Zephyr_S.jpg",
  "ZALA Lancet-3":               WKC + "Lancet_loitering_munition.jpg",
  "Orlan-10":                    WKC + "Orlan-10.jpg",
  "BZK-005 Chang Eagle":         WKC + "BZK-005.jpg",
  "Black Hornet 4 (PRS-IV)":    WKC + "Black_Hornet_Nano.jpg",
  "AeroVironment Switchblade 300": WKC + "AeroVironment_Switchblade_300.jpg",
  "AeroVironment Switchblade 600": WKC + "AeroVironment_Switchblade_600.jpg",
  "MQ-9B SeaGuardian":           WKC + "MQ-9_Reaper_in_flight_(disheveled).jpg",
  "MQ-9B SkyGuardian / Protector RG Mk.1": WKC + "MQ-9_Reaper_in_flight_(disheveled).jpg",
  "WB Group FlyEye":             WKC + "FlyEye_UAV.jpg",
  "WB Group Warmate":            WKC + "WB_Warmate.jpg",
  "Insitu ScanEagle":            WKC + "ScanEagle.jpg",
  "MQ-28A Ghost Bat":            WKC + "MQ-28_Ghost_Bat.jpg",
  "Orion MALE / UCAV":           WKC + "Kronshtadt_Orion.jpg",
  "Elbit Skylark 3":             WKC + "Elbit_Skylark_III.jpg",
  "Saab / UMS Skeldar V-200":    WKC + "Skeldar_V-200.jpg",
  // ── Missiles (recent additions) ─────────────────────────────────────────
  "9M723 Iskander-M":            WKC + "9K720_Iskander.jpg",
  "3M-54 Kalibr (Club)":         WKC + "Kalibr_cruise_missile.jpg",
  "3M22 Zircon (Tsirkon)":       WKC + "3M22_Zircon_missile.jpg",
  "Kh-101 / Kh-102":             WKC + "Kh-101_cruise_missile.jpg",
  "DF-17 Hypersonic Glide Vehicle": WKC + "DF-17_parade_2019.jpg",
  "UVision Hero-120":            WKC + "Hero-120_loitering_munition.jpg",
  // ── Land vehicles (recent additions) ────────────────────────────────────
  "T-15 Armata IFV":             WKC + "T-15_Armata.jpg",
  "Kurganets-25 IFV":            WKC + "Kurganets-25.jpg",
  "Type 99A MBT":                WKC + "ZTZ99A.jpg",
  "Type 15 Light Tank":          WKC + "Type_15_tank.jpg",
  "ZBD-04A IFV":                 WKC + "ZBD-04A.jpg",
  "Dingo II MRAP":               WKC + "ATF_Dingo_II.jpg",
  "Fennek (Spähpanzer)":         WKC + "Fennek.jpg",
  "Bushmaster PMV (Protected Mobility Vehicle)": WKC + "Bushmaster_PMV.jpg",
  "CENTAURO II B2 (VBC-120)":    WKC + "Centauro_B2.jpg",
  "VCC-80 Dardo IFV":            WKC + "VCC-80_Dardo.jpg",
  "BTR-82AM":                    WKC + "BTR-82A.jpg",
};
...
const WIKI_TITLES = {
  ...
  "Harfang MALE": "EADS Harfang",
  "Patroller MALE": "Safran Patroller",
  "EC725 Caracal": "H225M Caracal",
  "SA 342 Gazelle": "Aérospatiale Gazelle",
  "AS 532 Cougar": "Aérospatiale SA 332 Super Puma",
  ...
  // ── UAVs added in recent sessions ───────────────────────────────────────
  "Bayraktar Akinci": "Baykar Bayraktar Akıncı",
  "TAI ANKA-S": "TAI Anka",
  "TAI Aksungur": "TAI Aksungur",
  "TAI Anka-III": "TAI Anka",
  "Elbit Hermes 450": "Elbit Hermes 450",
  "Elbit Hermes 900": "Elbit Hermes 900",
  "IAI Heron 1 (Machatz-1)": "IAI Heron",
  "IAI Eitan (Heron 10)": "IAI Eitan",
  "CH-4B Rainbow (Caihong-4B)": "CASC Rainbow",
  "CH-5 Rainbow (Caihong-5)": "CASC Rainbow",
  "Wing Loong III (翼龙-3)": "CAIG Wing Loong II",
  "TB001 Twin-Tailed Scorpion": "CAIG Wing Loong II",
  "GJ-11 'Sharp Sword'": "Hongdu GJ-11",
  "MQ-25 Stingray": "Boeing MQ-25 Stingray",
  "RQ-170 Sentinel": "Lockheed Martin RQ-170 Sentinel",
  "Northrop Grumman MQ-8C Fire Scout": "Northrop Grumman MQ-8C Fire Scout",
  "Sukhoi S-70 Okhotnik-B": "Sukhoi S-70 Okhotnik-B",
  "Kronshtadt Altius-RU": "Sokol Altius",
  "Orion MALE / UCAV": "Kronshtadt Orion",
  "Shahed-131": "HESA Shahed 136",
  "Shahed-129": "Shahed 129",
  "Mohajer-6": "Qods Mohajer-6",
  "Airbus Zephyr S": "Airbus Zephyr",
  "Leonardo Falco EVO": "Selex ES Falco",
  "ZALA Lancet-3": "ZALA Lancet",
  "Orlan-10": "Orlan-10",
  "KUB-BLA Kamikaze UAV": "ZALA Lancet",
  "BZK-005 Chang Eagle": "Harbin BZK-005",
  "Black Hornet 4 (PRS-IV)": "Teledyne FLIR Black Hornet Nano",
  "AeroVironment Switchblade 300": "AeroVironment Switchblade",
  "AeroVironment Switchblade 600": "AeroVironment Switchblade",
  "MQ-9B SkyGuardian / Protector RG Mk.1": "General Atomics MQ-9 Reaper",
  "MQ-9B SeaGuardian": "General Atomics MQ-9 Reaper",
  "Airbus SIRTAP": "Airbus SIRTAP",
  "Tekever AR5": "Tekever",
  "Tekever StormShroud": "Tekever",
  "WB Group FlyEye": "WB Electronics FlyEye",
  "WB Group Warmate": "WB Electronics Warmate",
  "Insitu ScanEagle": "Insitu ScanEagle",
  "DRDO TAPAS BH-201 (Rustom-2)": "TAPAS-BH201",
  "HAL CATS Warrior": "Combat Air Teaming System",
  "Saab / UMS Skeldar V-200": "Skeldar V-200",
  "Aeronautics Orbiter 4": "Orbiter (UAV)",
  "Elbit Skylark 3": "Elbit Skylark",
  "Eurodrone (MALE RPAS)": "Eurodrone",
  "Malloy T-150": "Malloy Aeronautics",
  "KAI KUS-FS Tactical UAV": "Korea Aerospace Industries",
  "Nordic Unmanned Staaker BG-200": "Nordic Unmanned",
  // ── Missiles added in recent sessions ────────────────────────────────────
  "9M723 Iskander-M": "9K720 Iskander",
  "3M-54 Kalibr (Club)": "Kalibr (missile family)",
  "3M22 Zircon (Tsirkon)": "3M22 Zircon",
  "Kh-101 / Kh-102": "Kh-101",
  "DF-17 Hypersonic Glide Vehicle": "DF-17",
  "DF-21D Anti-Ship Ballistic Missile": "DF-21",
  "PL-15 Air-to-Air Missile": "PL-15",
  "YJ-12B Anti-Ship Missile": "YJ-12",
  "Sea Ceptor (CAMM)": "CAMM (missile family)",
  "S-350E Vityaz SAM": "S-350 Vityaz",
  "HJ-12 Anti-Tank Missile": "HJ-12",
  "Type 12 Surface-to-Ship Missile": "Type 12 surface-to-ship missile",
  "UVision Hero-120": "UVision Air",
  // ── Land vehicles added in recent sessions ────────────────────────────────
  "BMP-3M Upgrade": "BMP-3",
  "BTR-82AM": "BTR-80",
  "T-15 Armata IFV": "T-15 Armata",
  "Kurganets-25 IFV": "Kurganets-25",
  "Type 99A MBT": "Type 99 tank",
  "Type 15 Light Tank": "Type 15 tank",
  "ZBD-04A IFV": "ZBD-04",
  "Dingo II MRAP": "ATF Dingo",
  "Fennek (Spähpanzer)": "Fennek",
