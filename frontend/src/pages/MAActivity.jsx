...
const JV_EU_PROGRAMS = [
  ...
  { id: 1,  party1: "Auterion",          p1_iso: "DE", party2: "Airlogix",                p2_iso: "DE", products: "AI strike drones",           year: 2026,
    description: "Auterion, the software platform behind the open-source Skynode flight controller, partners with strike drone startup Airlogix to develop AI-guided autonomous UAS systems. The JV targets procurement contracts from German and European armed forces under the post-2022 accelerated rearmament drive." },
  { id: 2,  party1: "Quantum Systems",   p1_iso: "DE", party2: "WIY Drones",              p2_iso: "DE", products: "STRILA interceptors",          year: 2026,
    description: "Quantum Systems (maker of the Vector VTOL fixed-wing reconnaissance drone) and WIY Drones collaborate to produce STRILA interceptors, an autonomously guided counter-drone system. The deal targets short-range air defense markets in Central and Eastern Europe where the drone threat is deemed highest priority." },
  { id: 3,  party1: "Quantum Systems",   p1_iso: "DE", party2: "Tencore",                 p2_iso: "UA", products: "UGVs (TerMit UGV)",            year: 2026,
    description: "Quantum Systems pairs its aerial reconnaissance capabilities (Vector drone) with Tencore's unmanned ground vehicle expertise (TerMit UGV, 800+ units deployed in Ukraine). The partnership targets a combined aerial-ground robotic solution meeting NATO-standard requirements." },
  { id: 4,  party1: "Tencore",           p1_iso: "UA", party2: "Shark Robotics",          p2_iso: "FR", products: "Combat UGVs",                  year: 2026,
    description: "Strategic alliance announced April 21, 2026 between Tencore (Ukraine, TerMit UGV) and Shark Robotics (France, Colossus UGV). The two ground robotics champions join forces to develop and co-produce next-generation multi-mission UGVs for European and NATO markets, combining Tencore's combat-proven design with Shark's European industrial network." },
  { id: 5,  party1: "Rheinmetall",       p1_iso: "DE", party2: "Destinus",                p2_iso: "CH", products: "Cruise missiles",              year: 2026,
    description: "German defense giant Rheinmetall partners with Swiss hypersonic startup Destinus to develop high-speed cruise missile systems. The JV combines Rheinmetall's munitions manufacturing expertise with Destinus's hydrogen propulsion and high-speed flight technology." },
  { id: 6,  party1: "Helsing",           p1_iso: "DE", party2: "Culver Aerospace",        p2_iso: "DE", products: "Deep-strike UAS",              year: 2026,
    description: "AI defense company Helsing (signal processing and targeting software) teams up with Culver Aerospace to develop long-range deep-strike drones. Helsing contributes the autonomous decision-making AI stack while Culver provides the airframe architecture and propulsion." },
  { id: 7,  party1: "THYRA",             p1_iso: "DE", party2: "TAF Industries",          p2_iso: "FI", products: "Interceptors / C-UAS",         year: 2026,
    description: "German AI defense startup THYRA and Finnish manufacturer TAF Industries combine their technologies for counter-drone interceptor systems. THYRA brings AI-powered detection and targeting; TAF the physical interception hardware — targeting Nordic and Central European NATO armed forces." },
  { id: 8,  party1: "Summa Defence",     p1_iso: "FI", party2: "TAF Industries",          p2_iso: "FI", products: "FPV / ISR / C-UAS",            year: 2026,
    description: "Two Finnish drone ecosystem companies form a JV to produce FPV attack drones, ISR surveillance platforms, and counter-UAS systems. The consortium responds to accelerated acquisition programmes of the Finnish Defence Forces and Nordic NATO allies." },
  { id: 9,  party1: "Frankenburg Tech",  p1_iso: "DE", party2: "PGZ",                    p2_iso: "PL", products: "LEGIT tactical UGV",           year: 2026,
    description: "Frankenburg Tech (autonomous robotics, Germany) partners with PGZ, Poland's state-owned defense industrial group, to co-develop the LEGIT tactical unmanned ground vehicle. The JV gives Frankenburg access to Polish procurement — one of Europe's fastest-growing defense budgets." },
  { id: 10, party1: "Remtecnology",      p1_iso: "DE", party2: "New Paakkola Oy",         p2_iso: "FI", products: "LEGIT tactical UGV",           year: 2026,
    description: "Remtecnology (robotic systems, Germany) and Finnish manufacturer New Paakkola Oy collaborate to produce the LEGIT tactical UGV. The deal pairs Remtecnology's robotics engineering with Paakkola's established vehicle manufacturing infrastructure in Finland." },
  { id: 11, party1: "Ondas",             p1_iso: "US", party2: "HDAT (Heidelberger)",     p2_iso: "DE", products: "C-UAS Iron Drone",             year: 2026,
    description: "Ondas Holdings (USA) and Germany's HDAT (Heidelberger) partner to bring the Iron Drone autonomous interceptor system to European markets. The system neutralizes drone threats by physically intercepting them, protecting critical infrastructure and military installations." },
  // 2025 ──────────────────────────────────────────────────────────────────────
  { id: 12, party1: "Rheinmetall",       p1_iso: "DE", party2: "ICEYE",                  p2_iso: "FI", products: "SAR satellites",               year: 2025,
    description: "Rheinmetall and Finnish SAR satellite operator ICEYE form a JV to deliver persistent synthetic aperture radar imagery to military customers. ICEYE contributes its small satellite constellation; Rheinmetall its defense customer network and C2 system integration." },
  { id: 13, party1: "Quantum Systems",   p1_iso: "DE", party2: "Frontline Robotics",      p2_iso: "DE", products: "Recon UAV",                    year: 2025,
    description: "Quantum Systems and Frontline Robotics collaborate on next-generation VTOL fixed-wing reconnaissance drones. The JV combines Quantum's proven Vector platform with Frontline's sensor integration and battlefield communications expertise for European defense customers." },
  { id: 14, party1: "Prevail Partners",  p1_iso: "GB", party2: "Skyeton",                p2_iso: "UA", products: "Raybird UAS",                   year: 2025,
    description: "UK investment firm Prevail Partners backs Ukrainian drone maker Skyeton to scale production of the Raybird-3 long-endurance reconnaissance UAS, combat-tested extensively in the Ukraine conflict. The deal gives Skyeton access to British and NATO defense markets." },
  { id: 15, party1: "NVL / Rheinmetall", p1_iso: "DE", party2: "Kraken Technology",      p2_iso: "NO", products: "Autonomous vessels",            year: 2025,
    description: "German shipbuilder NVL and Rheinmetall partner with Norwegian autonomous systems specialist Kraken Technology to develop unmanned surface vessels (USVs). The tri-party consortium targets NATO naval requirements: mine countermeasures, maritime ISR, and coastal force protection." },
  { id: 16, party1: "AIRO",             p1_iso: "AT", party2: "Nord Drone Group",        p2_iso: "NO", products: "FPV / loitering",              year: 2025,
    description: "Austrian drone company AIRO and Norway's Nord Drone Group partner to develop FPV attack drones and loitering munitions. The JV targets Scandinavian and Central European markets where demand for low-cost autonomous munitions is growing rapidly." },
  { id: 17, party1: "Summa Defence",     p1_iso: "FI", party2: "Griselda",               p2_iso: "FI", products: "AI situational awareness",     year: 2025,
    description: "Finland's Summa Defence and Griselda collaborate to develop AI-powered battlefield situational awareness systems. The JV aggregates drone and sensor data streams to produce real-time operational intelligence for Nordic armed forces." },
  { id: 18, party1: "MITS Industries",   p1_iso: "DE", party2: "Tencore / Infozahyst",   p2_iso: "UA", products: "UGVs",                         year: 2025,
    description: "Germany's MITS Industries partners with the Ukrainian consortium Tencore / Infozahyst to develop ground robots combining autonomous mobility with electronic warfare capabilities. The deal integrates combat-proven Ukrainian technology into German-quality systems meeting NATO standards." },
  { id: 19, party1: "Wingcopter",        p1_iso: "DE", party2: "TAF Industries",         p2_iso: "FI", products: "Recon UAVs",                   year: 2025,
    description: "German VTOL drone manufacturer Wingcopter (known for medical delivery) applies its platform expertise to military ISR in partnership with Finland's TAF Industries. The JV adapts civilian VTOL platforms for tactical reconnaissance missions targeting Nordic defense customers." },
  { id: 20, party1: "AIRO",             p1_iso: "AT", party2: "Bullet",                 p2_iso: "FI", products: "Interceptors",                 year: 2025,
    description: "Austria's AIRO and Finland's Bullet develop drone interception systems, addressing growing demand from Nordic NATO members for C-UAS capabilities. The partnership combines AIRO's aerial platforms with Bullet's interception payload expertise." },
  { id: 21, party1: "Kongsberg",         p1_iso: "NO", party2: "Helsing",                p2_iso: "DE", products: "ISR satellite constellation",  year: 2025,
    description: "Norwegian defense leader Kongsberg and German AI company Helsing partner to develop an ISR satellite constellation with onboard AI signal processing. The JV aims to provide European armed forces with affordable, high-revisit-rate autonomous space-based battlefield surveillance." },
  // 2024 ──────────────────────────────────────────────────────────────────────
  { id: 22, party1: "Summa Defence",     p1_iso: "FI", party2: "Kort / Elf / Skyassist", p2_iso: "FI", products: "UAV / UGV / USV",             year: 2024,
    description: "Summa Defence leads a multi-company consortium with Kort, Elf, and Skyassist to build a comprehensive autonomous systems portfolio spanning air, land, and sea domains. The broad-scope JV targets Finnish Defence Forces procurement under the country's accelerated post-NATO-accession defense investment." },
  { id: 23, party1: "Space42",           p1_iso: "AE", party2: "ICEYE",                 p2_iso: "FI", products: "SAR satellite manufacturing",  year: 2024,
    description: "UAE space company Space42 (formerly Yahsat) and Finland's ICEYE partner to localize SAR satellite manufacturing in the UAE. The JV creates a Middle East hub for advanced reconnaissance satellite production, leveraging ICEYE's synthetic aperture radar technology and Finnish engineering expertise." },
  // Landmark structural programmes ─────────────────────────────────────────────
  { id: 24, party1: "Airbus D&S",        p1_iso: "DE", party2: "Thales Alenia Space + RADMOR", p2_iso: "PL", products: "Poland military GEO satellite", year: 2026,
    description: "Airbus Defence & Space, Thales Alenia Space, and Poland's RADMOR (WB Group) sign an industrial cooperation agreement on April 20, 2026 in Gdańsk for Poland's first sovereign military geostationary satellite. Airbus leads the platform, Thales the military comms payloads, and RADMOR the cyber-secured ground infrastructure." },
  { id: 25, party1: "NVL / Rheinmetall", p1_iso: "DE", party2: "Rheinmetall (OMFV)",    p2_iso: "US", products: "Lynx KF41 OMFV (US Army)",    year: 2022,
    description: "Rheinmetall establishes American Rheinmetall Vehicles LLC to compete for the US Army's Optionally Manned Fighting Vehicle (OMFV) programme, centered on the Lynx KF41 built in the United States under Buy American provisions. The programme is estimated at over $45 billion across its lifetime." },
  { id: 26, party1: "Naval Group",       p1_iso: "FR", party2: "Fincantieri",            p2_iso: "IT", products: "Naviris — naval export JV",   year: 2020,
    description: "Naval Group (France) and Fincantieri (Italy) create Naviris, a 50/50 JV headquartered in Genoa, to coordinate naval export programmes and European naval cooperation. Naviris serves as the common vehicle for joint bids on European programmes including PANG and FREMM follow-ons." },
  { id: 27, party1: "Airbus D&S",        p1_iso: "DE", party2: "Dassault + Leonardo",   p2_iso: "EU", products: "Eurodrone MALE UAS",           year: 2020,
    description: "Airbus D&S (40%), Dassault Aviation (40%), and Leonardo (20%) form a JV to develop the Eurodrone, Europe's MALE UAS under a €7.1B ESA/OCCAR contract signed in 2023. Eurodrone will serve Germany, France, Spain, and Italy with first flight targeted for 2028." },
  { id: 28, party1: "Rheinmetall",       p1_iso: "DE", party2: "BAE Systems",            p2_iso: "GB", products: "RBSL — Ajax / Boxer / CR3",   year: 2019,
    description: "Rheinmetall and BAE Systems create RBSL (Rheinmetall BAE Systems Land), a 50/50 JV, to deliver the British Army's next-generation armoured vehicles. RBSL holds the Ajax prime contract, serves as UK national integrator for Boxer, and supports the Challenger 3 upgrade programme." },
  { id: 29, party1: "KNDS France",       p1_iso: "FR", party2: "KNDS Deutschland + Rheinmetall", p2_iso: "DE", products: "MGCS next-gen battle tank (2035+)", year: 2018,
    description: "The Franco-German MGCS programme targets a next-generation battle tank to replace Leclerc and Leopard 2 by 2035+. The industrial alliance brings together KNDS France, KNDS Deutschland, and Rheinmetall — with work-share contested between the partners and renegotiations ongoing as of 2026." },
  { id: 30, party1: "Dassault Aviation", p1_iso: "FR", party2: "Airbus D&S + Indra",    p2_iso: "EU", products: "FCAS / SCAF NGF (2040+)",      year: 2017,
    description: "France, Germany, and Spain launch the FCAS/SCAF programme with Dassault (NGF prime), Airbus D&S (Remote Carriers), and Indra (EW). Phase 1B contracts worth €3.5B were signed in 2022; persistent industrial work-share tensions between Airbus and Dassault have led to repeated near-breakdowns." },
  { id: 31, party1: "Airbus",            p1_iso: "FR", party2: "Safran",                 p2_iso: "FR", products: "ArianeGroup — Ariane 6 / M51", year: 2015,
    description: "Airbus and Safran merge their space propulsion and launch vehicle activities into ArianeGroup, a 50/50 holding company, creating Europe's sovereign space access champion. ArianeGroup is the exclusive ESA prime contractor for Ariane 6 and develops the M51 submarine-launched ballistic missile for the French Navy." },
  { id: 32, party1: "Airbus",            p1_iso: "FR", party2: "BAE Systems + Leonardo", p2_iso: "EU", products: "MBDA — Meteor / Aster / Storm Shadow", year: 2001,
    description: "Airbus (37.5%), BAE Systems (37.5%), and Leonardo (25%) create MBDA, Europe's largest missile systems integrator. MBDA produces Meteor, Aster, Brimstone, Exocet, Storm Shadow/SCALP, and the CAMM family — with tri-national governance preserving each nation's export sovereignty while pooling R&D." },
  { id: 33, party1: "MBDA",              p1_iso: "FR", party2: "Thales",                 p2_iso: "FR", products: "Eurosam — SAMP/T Aster 30",    year: 1989,
    description: "Eurosam is a JV between MBDA (66%) and Thales (34%) producing the SAMP/T (Aster 30) medium-range surface-to-air missile system, deployed by France, Italy, Singapore, and Ukraine. The modernised SAMP/T NG version is now being delivered to NATO allies as a theatre missile defence solution." },
