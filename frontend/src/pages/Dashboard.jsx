...
export default function Dashboard() {
  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center h-64 gap-3">
        <div className="animate-spin w-8 h-8 border-2 border-slate-200 border-t-blue-800 rounded-full" />
  ...
  return (
    <div data-testid="dashboard-page" className="space-y-6 animate-fade-in">
      ...
      <div className="bg-blue-50 border border-blue-100 rounded-xl px-5 py-4 flex flex-wrap gap-6 items-center">
        <div className="flex items-center gap-2">
          <Zap className="w-4 h-4 text-blue-700" />
          <span className="text-xs font-semibold text-blue-800 uppercase tracking-wider">This week</span>
        </div>
        <div className="flex flex-wrap gap-4">
          <div className="flex items-center gap-1.5">
            ...
            {weeklyMA.length > 0 && (
              <Link to="/ma-activity" className="text-[10px] text-blue-700 hover:text-blue-900 font-medium ml-1">→</Link>
            )}
          </div>
          <div className="w-px h-4 bg-blue-200 self-center" />
          <div className="flex items-center gap-1.5">
...
const METRIC_COLORS = {
  "TOTAL MARKET CAP":     { iconCls: "text-blue-800", bgCls: "bg-blue-50", topBorder: "border-t-2 border-t-blue-700" },
