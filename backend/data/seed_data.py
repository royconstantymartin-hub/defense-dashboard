...
DEFENSE_COMPANIES = [
    ...
    {"name": "Thales Nederland", "ticker": "THNL-PRIV", "country": "Netherlands", "market_cap": 2.2, "stock_price": 0, "change_percent": 0, "revenue": 1.1, "employees": 2000, "specializations": ["Radar", "Naval", "Sensors", "C4I"], "founded_year": 1922, "headquarters": "Hengelo, Netherlands", "website": "thalesgroup.com/netherlands", "funding_stage": "Private — Thales SA subsidiary", "description": "Thales Nederland is the European leader in naval radar and combat management systems. Its SMART-L long-range surveillance radar, APAR active phased array fire control radar, and TACTICOS combat management system equip frigates across 10+ navies including Netherlands, Denmark, Belgium, Germany, and Canada. The SMART-L ELT variant provides early warning against ballistic missiles."},
    # === Belgium ===
