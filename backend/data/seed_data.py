...
PRODUCTS_DATA = [
    ...
    {"name": "Eurodrone MALE", "manufacturer": "Airbus Defence & Space", "category": "aircraft", "product_type": "uav", "specifications": {"class": "MALE ISTAR", "role": "ISR / signals intelligence / armed patrol", "endurance": "Ultra-long (40h+)", "payload": "Medium-heavy — multi-sensor + weapons optional", "ceiling": "High (FL450)", "propulsion": "Turboprop (×2)"}, "materials": ["Carbon Fiber Composites", "Advanced Avionics"], "status": "development", "image_url": "https://upload.wikimedia.org/wikipedia/commons/3/37/MQ-9_Reaper_in_flight_(disheveled).jpg"},
