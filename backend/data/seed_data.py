...
PRODUCTS_DATA = [
    ...
    {"name": "Vector UAV", "manufacturer": "Quantum Systems", "category": "aircraft", "product_type": "uav", "specifications": {"class": "VTOL mini UAV", "role": "Close ISR / urban surveillance", "endurance": "Short", "payload": "Ultra-light", "ceiling": "Low", "propulsion": "Electric"}, "materials": ["Composite Materials", "Electric Propulsion", "Modular Payload Bay"], "status": "active", "image_url": "https://upload.wikimedia.org/wikipedia/commons/5/56/Watchkeeper_WK450_UAV.jpg"},
