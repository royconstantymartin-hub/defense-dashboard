...
ANNOUNCEMENTS_DATA = [
    ...
    # ArianeGroup / Thales
    {"title": "Thales et ArianeGroup s'associent pour la surveillance spatiale européenne", "content": "Thales et ArianeGroup annoncent un partenariat stratégique pour développer un réseau de surveillance de l'espace (Space Situational Awareness) au profit de l'Agence Spatiale Européenne et des forces armées françaises. Le contrat-cadre, d'une valeur de €620 millions sur dix ans, couvre capteurs sol, logiciels de corrélation et intégration avec le système Ariane 6.", "source": "Opex News", "category": "partnership", "company": "Thales"},
    {"title": "ArianeGroup confie à Thales la charge utile militaire d'Ariane 6", "content": "Dans le cadre du programme de lancement militaire Ariane 6, ArianeGroup sélectionne Thales comme maître d'œuvre des charges utiles de renseignement électromagnétique (SIGINT) embarquées. Premier lancement opérationnel prévu au T3 2026.", "source": "Air & Cosmos", "category": "contract", "company": "Thales"},
    {"title": "Ariane 6 : succès du premier tir de qualification avec charge utile Thales", "content": "Le lanceur lourd Ariane 6 réalise avec succès son quatrième vol depuis le Centre Spatial Guyanais, emportant en orbite polaire un satellite de démonstration développé par Thales Alenia Space pour le compte de la DGA. Ce vol valide l'interface lanceur-charge utile avant les missions opérationnelles prévues en 2026.", "source": "SpaceNews", "category": "product_launch", "company": "ArianeGroup"},
    {"title": "Thales Alenia Space remporte le contrat du satellite CSO-4", "content": "La Direction Générale de l'Armement attribue à Thales Alenia Space le développement du satellite militaire d'observation CSO-4, qui sera mis en orbite par Ariane 6. Valeur du contrat : €1,1 milliard. Livraison prévue en 2028.", "source": "Les Echos", "category": "contract", "company": "Thales"},
    {"title": "ArianeGroup et Thales renforcent leur coopération sur la propulsion spatiale verte", "content": "Les deux groupes français signent un accord de R&D pour développer des propulseurs à ergols verts de nouvelle génération destinés aux étages supérieurs d'Ariane 6 et aux satellites militaires. L'UE finance 40 % du projet via le Fonds européen de défense.", "source": "Reuters", "category": "partnership", "company": "ArianeGroup"},
]
...
PRODUCTS_DATA = [
    ...
    {"name": "Harmattan Combat Drone", "manufacturer": "Harmattan AI", "category": "aircraft", "product_type": "uav", "specifications": {"flight_type": "Fixed-wing (catapult/belly-land)", "max_speed": "160 km/h", "range": "150 km", "endurance": "6+ hours", "payload": "EO/IR ISR or micro-munition", "autonomy": "Edge AI — GPS-denied capable"}, "materials": ["Carbon Fiber Composite", "Embedded AI Processor", "Modular Payload Bay"], "status": "active", "image_url": "https://upload.wikimedia.org/wikipedia/commons/7/75/ScanEagle_on_SuperWedge_launcher.jpg"},
