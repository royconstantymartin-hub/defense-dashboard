...
DEFENSE_COMPANIES = [
    ...
    {"name": "Preligens", "ticker": "PREL-PRIV", "country": "France", "market_cap": 0.17, "stock_price": 0, "change_percent": 0, "revenue": 0.05, "employees": 130, "specializations": ["AI", "Satellite Imagery", "GEOINT", "ISR"], "founded_year": 2016, "headquarters": "Paris, France", "website": "preligens.com", "funding_stage": "Growth", "is_public": False, "description": "Preligens (formerly Earthcube) applies deep learning to satellite and aerial imagery for military intelligence analysis. Its AI automatically detects and classifies military assets — aircraft, vehicles, ships — in commercial satellite imagery, dramatically reducing the analyst time required for pattern-of-life and order-of-battle assessments. Preligens is a key supplier to French DGA (defence procurement) and has contracts with NATO allies for AI-accelerated GEOINT production."},
    {
