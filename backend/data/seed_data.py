...
PRODUCTS_DATA = [
    ...
    {"name": "Challenger 2 / 2 LEP MBT", "manufacturer": "BAE Systems Land (formerly Vickers)", "category": "land", "product_type": "mbt", "specifications": {"role": "Main Battle Tank", "weight": "62.5 t (standard) / ~66 t (LEP)", "crew": "4", "main_gun": "120mm L30A1 rifled (56 APFSDS rounds)", "secondary": "1× 7.62mm coaxial, 1× 7.62mm cupola", "speed": "59 km/h (road)", "range": "450 km", "protection": "Chobham 2 / Dorchester composite armor + ERA options (LEP)", "operators": "British Army, Oman, Ukraine (donated, ~14 units)"}, "materials": ["Chobham 2 / Dorchester Composite Armor", "ROMOR-A ERA (LEP upgrade)", "L30A1 120mm Rifled Barrel"], "status": "active", "image_url": "https://upload.wikimedia.org/wikipedia/commons/4/4d/Challenger2_Iraq.jpg"},
    ...
    {"name": "ZALA Lancet-3", "manufacturer": "ZALA Aero Group (Kalashnikov Concern)", "category": "aircraft", "product_type": "uav",
     ...
     "description": "Russia's most widely deployed loitering munition in the Ukraine conflict — the X-wing Lancet-3 has become the defining precision-strike drone of the 2022–2025 war. Produced by ZALA Aero (Kalashnikov), it uses optical/IR homing to engage artillery systems, radar units, and armored vehicles from above. Over 2,000 confirmed strike attempts documented by Oryx by late 2023, with verified kills of M777 howitzers, Panzerhaubitze 2000, and IRIS-T launchers. Mass-produced at Izhevsk; Ukraine fields counter-drone systems specifically tuned to the Lancet threat."},
