...
DEFENSE_COMPANIES = [
    ...
    {"name": "Helsing", "ticker": "HLSG-PRIV", "country": "Germany", "market_cap": 5.4, "stock_price": 0, "change_percent": 0, "revenue": 0.1, "employees": 500, "specializations": ["AI", "Electronic Warfare", "Sensor Fusion", "Autonomous"]},
    {"name": "Ghost Robotics", "ticker": "GRBT-PRIV", "country": "USA", "market_cap": 0.8, "stock_price": 0, "change_percent": 0, "revenue": 0.1, "employees": 200, "specializations": ["Robotics", "UGV", "Autonomous", "ISR"]},
    {"name": "Epirus", "ticker": "EPIR-PRIV", "country": "USA", "market_cap": 1.6, "stock_price": 0, "change_percent": 0, "revenue": 0.1, "employees": 300, "specializations": ["Directed Energy", "Counter-UAS", "HPM"]},
    {"name": "Milrem Robotics", "ticker": "MLRM-PRIV", "country": "Estonia", "market_cap": 0.6, "stock_price": 0, "change_percent": 0, "revenue": 0.1, "employees": 350, "specializations": ["UGV", "Robotics", "Autonomous", "Land Systems"]},
    {"name": "Quantum Systems", "ticker": "QSYS-PRIV", "country": "Germany", "market_cap": 0.5, "stock_price": 0, "change_percent": 0, "revenue": 0.05, "employees": 200, "specializations": ["UAV", "VTOL", "ISR", "Autonomous"]},
    {"name": "Exail Technologies", "ticker": "EXAI-PRIV", "country": "France", "market_cap": 0.9, "stock_price": 0, "change_percent": 0, "revenue": 0.5, "employees": 2400, "specializations": ["Naval Autonomy", "USV", "UUV", "Navigation"]},
    {"name": "Harmattan AI", "ticker": "HARM-PRIV", "country": "France", "market_cap": 1.54, "stock_price": 0, "change_percent": 0, "revenue": 0.1, "employees": 160, "specializations": ["AI", "Autonomous", "UAV", "Electronic Warfare", "Air Defense"]},
]
...
PRODUCTS_DATA = [
    ...
    {"name": "Lattice AI Platform", "manufacturer": "Anduril Industries", "category": "cyber", "product_type": "software", "specifications": {"type": "AI-driven C2/ISR fusion", "deployment": "Edge/Cloud hybrid", "integration": "Multi-domain sensors", "latency": "<500ms"}, "materials": ["Machine Learning Stack", "Sensor Fusion Engine", "Edge Computing Nodes"], "status": "active", "image_url": "https://upload.wikimedia.org/wikipedia/commons/4/47/PNG_transparency_demonstration_1.png"},
    ...
    {"name": "Heron Systems AI Dogfighter", "manufacturer": "Helsing", "category": "cyber", "product_type": "software", "specifications": {"type": "AI aerial combat agent", "capability": "BVR + WVR autonomous combat", "latency": "<1ms decision loop", "platform": "Fighter aircraft integration"}, "materials": ["Reinforcement Learning AI", "High-Speed Inference Engine", "Secure Avionics Interface"], "status": "development", "image_url": "https://upload.wikimedia.org/wikipedia/commons/1/16/F-35A_CTOL_variant.jpg"},
    ...
    {"name": "V-BAT VTOL Drone", "manufacturer": "Shield AI", "category": "aircraft", "product_type": "uav", "specifications": {"max_speed": "185 km/h", "range": "370 km", "endurance": "12 hours", "autonomy": "Hivemind AI autonomous VTOL"}, "materials": ["Carbon Fiber", "Composite Fuselage", "Electric/Hybrid Propulsion"], "status": "active", "image_url": "https://upload.wikimedia.org/wikipedia/commons/c/c6/MQ-4C_Triton.jpg"},
    ...
    {"name": "Puma AE UAS", "manufacturer": "AeroVironment", "category": "aircraft", "product_type": "uav", "specifications": {"max_speed": "83 km/h", "range": "15 km", "endurance": "2.5 hours", "role": "ISR / Hand-launched"}, "materials": ["Composite Materials", "Electric Propulsion", "EO/IR Camera"], "status": "active", "image_url": "https://upload.wikimedia.org/wikipedia/commons/c/c6/MQ-4C_Triton.jpg"},
    {"name": "JUMP 20 VTOL UAS", "manufacturer": "AeroVironment", "category": "aircraft", "product_type": "uav", "specifications": {"max_speed": "140 km/h", "range": "185 km", "endurance": "14 hours", "autonomy": "BVLOS autonomous"}, "materials": ["Carbon Fiber", "Composite Materials", "Multi-mode Propulsion"], "status": "active", "image_url": "https://upload.wikimedia.org/wikipedia/commons/d/d9/MQ-1C_Gray_Eagle.jpg"},

    # === Defense Tech — Quantum Systems (Germany) ===
    {"name": "Trinity F90+", "manufacturer": "Quantum Systems", "category": "aircraft", "product_type": "uav", "specifications": {"max_speed": "72 km/h cruise", "range": "100 km", "endurance": "90 min", "launch": "VTOL to fixed-wing transition"}, "materials": ["Carbon Fiber", "Folding Composite Wings", "Hybrid Electric Propulsion"], "status": "active", "image_url": "https://upload.wikimedia.org/wikipedia/commons/5/56/Watchkeeper_WK450_UAV.jpg"},
    {"name": "Vector UAV", "manufacturer": "Quantum Systems", "category": "aircraft", "product_type": "uav", "specifications": {"max_speed": "90 km/h", "range": "60 km", "endurance": "2 hours", "payload": "1.5 kg EO/IR"}, "materials": ["Composite Materials", "Electric Propulsion", "Modular Payload Bay"], "status": "active", "image_url": "https://upload.wikimedia.org/wikipedia/commons/5/56/Watchkeeper_WK450_UAV.jpg"},

    # === Defense Tech — Exail Technologies (France) ===
    {"name": "DG100 Autonomous USV", "manufacturer": "Exail Technologies", "category": "naval", "product_type": "usv", "specifications": {"length": "5.5 m", "speed": "15 knots", "endurance": "72 hours", "role": "Mine countermeasures / ISR"}, "materials": ["Carbon Fiber Hull", "Electric/Diesel Hybrid", "Sonar & Sensor Suite"], "status": "active", "image_url": "https://upload.wikimedia.org/wikipedia/commons/c/cc/HMS_Visby_K31.jpg"},
    {"name": "IDEFX Autonomous UUV", "manufacturer": "Exail Technologies", "category": "naval", "product_type": "uuv", "specifications": {"depth": "3,000 m", "endurance": "48 hours", "speed": "6 knots", "role": "Seabed survey / MCM"}, "materials": ["Titanium Pressure Vessel", "Composite Fairing", "Sonar Arrays"], "status": "active", "image_url": "https://upload.wikimedia.org/wikipedia/commons/7/75/USS_Virginia_(SSN_774)_underway.jpg"},

    # === Defense Tech — Harmattan AI (France) ===
    {"name": "Harmattan Combat Drone", "manufacturer": "Harmattan AI", "category": "aircraft", "product_type": "uav", "specifications": {"type": "Autonomous combat UAS", "role": "Strike / ISR", "autonomy": "Edge AI — no comms required", "production": "Scalable to 1,000s/month"}, "materials": ["Composite Airframe", "Embedded AI Processor", "Modular Payload Bay"], "status": "active", "image_url": "https://upload.wikimedia.org/wikipedia/commons/a/a4/XQ-58A_Valkyrie_demonstrator.jpg"},
    {"name": "Harmattan Layered Air Defense", "manufacturer": "Harmattan AI", "category": "missile", "product_type": "sam", "specifications": {"type": "Autonomous counter-UAS / air defense", "layers": "Detect / Track / Intercept", "AI": "Real-time threat classification", "deployment": "Fixed site / mobile"}, "materials": ["Radar + EO/IR Sensors", "AI Intercept Computer", "Modular Launcher"], "status": "active", "image_url": "https://upload.wikimedia.org/wikipedia/commons/e/e2/AN-TPS-80_CTOR_radar.jpg"},
    {"name": "Harmattan EW Suite", "manufacturer": "Harmattan AI", "category": "cyber", "product_type": "electronic_warfare", "specifications": {"type": "Autonomous EW for UAS platforms", "capability": "Jamming / Spoofing / SIGINT", "integration": "Onboard drone payload", "AI": "Adaptive signal response"}, "materials": ["Software-Defined Radio", "GaN Amplifiers", "Edge AI Chips"], "status": "development", "image_url": "https://upload.wikimedia.org/wikipedia/commons/b/b6/EA-18G_Growler.jpg"},
    {"name": "Harmattan C2 Platform", "manufacturer": "Harmattan AI", "category": "cyber", "product_type": "software", "specifications": {"type": "Unified autonomous systems C2", "deployment": "Tactical edge / cloud", "integration": "Multi-drone swarm control", "AI": "Mission-level autonomy"}, "materials": ["AI Mission Planner", "Secure Comms Stack", "Edge Computing Nodes"], "status": "active", "image_url": "https://upload.wikimedia.org/wikipedia/commons/6/66/Palantir_logo.svg"},
